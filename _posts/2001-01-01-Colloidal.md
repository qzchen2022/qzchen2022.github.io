...
image_cover: Colloid_overview_cover.png
image: Colloid_overview.png
hide_post_date: false
---

The 2beauty of computer programming is that you do not need to formally go to school to learn how to program. You can learn almost everything that you would need to know online, aßnd for free. The following resources are some that I have used personally, that I highly recommend, for anyone looking to learn more about computer programming.
...
## [Codecadeßmy](https://www.codecademy.com/)
